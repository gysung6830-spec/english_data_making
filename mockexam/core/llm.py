...
_DIFFICULTY_SPEC = {
    "하": "쉬운 기본 어휘·짧은 문장. 정답 단서가 지문에 명시적으로 드러남(추론 1단계). "
          "오답은 지문과 명백히 무관·모순이라 소거가 쉽다. 빈칸은 반복·부연된 지엽 정보 자리.",
    "중": "표준 수능 수준 어휘. 추론 1~2단계. 오답 유의어 함정은 보통 수준. "
          "빈칸은 문단 요지에 해당하는 자리.",
    "중상": "고난도 어휘 1~2개 포함, 복문 일부. 추론 2단계. 오답 중 1개는 '부분적으로는 "
            "맞지만 범위가 좁거나 넓은' 매력적 함정. 빈칸은 글 전체 논지를 종합해야 풀리는 자리. "
            + _HARD_VOCAB,
    "상": "고난도 어휘·복문 다수. 추론 2~3단계. 오답 유의어가 정답과 매우 근접해 정밀 독해가 "
          "필요. 빈칸은 추상적 핵심 명제 자리. 함의·밑줄형은 축자적 오독을 유도하는 함정을 강화. "
          + _HARD_VOCAB,
}
