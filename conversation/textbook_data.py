...
# ============================================================
# 워드뱅크 확장: 각 단원의 빈칸에 보기 단어를 2개씩 더 추가(5개 → 7개).
#   - _EXTRA[단원번호] = [빈칸1 추가보기, 빈칸2 추가보기, ...] (빈칸 순서대로)
#   - 각 추가보기 = [(영어, 뜻), (영어, 뜻)]
#   - 첫 보기는 그대로 유지되므로 암기 페이지 모범문에는 영향 없음
# ============================================================
_EXTRA = {
    1: [[("friendly", "친근한"), ("kind", "다정한")],
        [("laugh a lot together", "함께 많이 웃다"), ("understand each other", "서로 이해하다")],
        [("encourage me", "격려해주다"), ("take care of me", "돌봐주다")],
        [("eat out together", "함께 외식하다"), ("go shopping together", "함께 쇼핑하다")],
        [("close", "가까운"), ("happy", "행복한")]],
    2: [[("clean", "깨끗한"), ("bright", "밝은")],
        [("the rooftop", "옥상"), ("the yard", "마당")],
        [("it feels warm", "아늑하다"), ("my family is there", "가족이 있다")],
        [("close to school", "학교에서 가까운"), ("lively", "활기찬")],
        [("play games", "게임을 하다"), ("watch videos", "영상을 보다")],
        [("free", "자유로운"), ("cozy", "아늑한")]],
    3: [[("field trips", "현장학습"), ("sports day", "운동회")],
        [("art", "미술"), ("P.E.", "체육")],
        [("exciting", "신나는"), ("practical", "실용적인")],
        [("the activities are fun", "활동이 재미있다"), ("the class is lively", "수업이 활기차다")],
        [("gives good examples", "좋은 예를 든다"), ("treats us fairly", "공평하게 대한다")],
        [("history", "역사"), ("math", "수학")],
    ...
    4: [[("listening to music", "음악 감상"), ("playing games", "게임하기")],
        ...
        [("enjoy free time", "여가를 즐기다"), ("feel happy", "행복해지다")],
        [("happy", "행복한"), ("calm", "차분한")],
        [("join a club", "동아리에 들다"), ("spend hours on it", "몇 시간씩 몰두하다")],
        [("interesting", "흥미로운"), ("balanced", "균형 잡힌")]],
    5: [[("volleyball", "배구"), ("table tennis", "탁구")],
        [("badminton", "배드민턴"), ("hiking", "등산")],
        [("flexibility", "유연성"), ("balance", "균형감각")],
        [("practice", "연습"), ("cooperation", "협동")],
        [("play with my friends", "친구들과 하다"), ("ride my bike every day", "매일 자전거를 타다")],
        [("active", "활동적인"), ("positive", "긍정적인")]],
    6: [[("bibimbap", "비빔밥"), ("ramen", "라면")],
        [("Italian", "이탈리안"), ("healthy", "건강한")],
        [("nice smell", "좋은 향"), ("soft texture", "부드러운 식감")],
        [("really tasty", "정말 맛있는"), ("popular", "인기 있는")],
        [("share it with friends", "친구들과 나눠 먹다"), ("have it for lunch", "점심으로 먹다")],
        [("tastes amazing", "정말 맛있다"), ("makes my day better", "하루를 좋게 만든다")]],
    7: [[("best friends", "최고의 친구"), ("buddies", "단짝")],
        [("puppy", "강아지"), ("turtle", "거북이")],
        [("gentle and kind", "온순하고 착한"), ("always happy to see me", "늘 반겨주는")],
        [("caring for others", "남을 돌보는 법"), ("good habits", "좋은 습관")],
        [("wait for you all day", "하루 종일 기다리다"), ("follow you around", "졸졸 따라다니다")],
        [("happy", "행복한"), ("cheerful", "밝은")]],
    8: [[("early spring", "이른 봄"), ("late fall", "늦가을")],
        [("breezy", "산들바람 부는"), ("clear", "맑은")],
        [("the leaves are pretty", "단풍이 예쁘다"), ("everything feels fresh", "모든 게 상쾌하다")],
        [("go camping", "캠핑을 가다"), ("play outside", "밖에서 놀다")],
        [("early summer", "초여름"), ("the weekend", "주말")],
        [("play sports", "운동을 하다"), ("walk in the park", "공원을 산책하다")],
    ...
    9: [[("horror", "공포"), ("sci-fi", "SF")],
        ...
        [("beat", "비트"), ("mood", "분위기")],
        [("a comedy movie", "코미디 영화"), ("a famous song", "유명한 노래")],
        [("moving", "감동적인"), ("cool", "멋진")],
        [("have fun", "즐기다"), ("escape for a while", "잠시 벗어나다")]],
    10: [[("London", "런던"), ("Sydney", "시드니")],
         [("learn new things", "새로운 걸 배우다"), ("take lots of photos", "사진을 많이 찍다")],
         [("make good memories", "좋은 추억을 만들다"), ("feel free", "자유를 느끼다")],
         [("tried local food", "현지 음식을 먹었다"), ("stayed at a hotel", "호텔에 묵었다")],
         [("fun", "재미있는"), ("special", "특별한")]],
    11: [[("kind", "친절한"), ("honest", "정직한")],
         [("games", "게임"), ("cooking", "요리")],
         [("friendly to all", "모두에게 친근한"), ("cheerful", "밝은")],
         [("speaking English", "영어 말하기"), ("dancing", "춤")],
         [("draw pictures", "그림을 그리다"), ("play games", "게임을 하다")],
         [("kind", "친절한"), ("hard-working", "성실한")]],
    12: [[("understanding", "이해심 있는"), ("loyal", "의리 있는")],
         [("funny", "웃긴"), ("kind", "다정한")],
         [("trust each other", "서로 믿다"), ("spend time together", "함께 시간을 보내다")],
         [("have lunch", "점심을 먹다"), ("chat", "수다를 떨다")],
         [("exciting", "신나는"), ("special", "특별한")]],
    13: [[("a local shop", "동네 가게"), ("an outlet", "아울렛")],
         [("accessories", "액세서리"), ("stationery", "문구")],
         [("quick and easy", "빠르고 쉬운"), ("full of choices", "선택지가 많은")],
         [("check reviews", "후기를 확인하다"), ("set a budget", "예산을 정하다")],
         [("bought a gift", "선물을 샀다"), ("found a good deal", "좋은 할인을 찾았다")],
         [("nice", "즐거운"), ("everyday", "일상적인")]],
    14: [[("have a drink", "음료를 마시다"), ("take a break", "잠시 쉬다")],
         [("an americano", "아메리카노"), ("a milkshake", "밀크셰이크")],
         [("warm and pleasant", "따뜻하고 쾌적한"), ("never too noisy", "시끄럽지 않은")],
    ...
    16: [[("rock", "록"), ("pop", "팝")],
         ...
         [("danced with the crowd", "관객과 함께 춤췄다"), ("met a singer", "가수를 만났다")],
         [("amazed", "감탄한"), ("alive", "살아 있는 듯한")]],
    17: [[("escape the city", "도시를 벗어나다"), ("breathe fresh air", "맑은 공기를 마시다")],
         [("the fresh air", "상쾌한 공기"), ("being in nature", "자연 속에 있는 것")],
         [("away from the city", "도시에서 벗어난"), ("exciting", "신나는")],
         [("made a campfire", "캠프파이어를 피웠다"), ("enjoyed nature", "자연을 즐겼다")],
         [("peaceful", "평화로운"), ("recharged", "재충전된")]],
    18: [[("healthy", "건강한"), ("enjoyable", "즐거운")],
         [("soup", "수프"), ("pancakes", "팬케이크")],
         [("eat healthy food", "건강한 음식을 먹다"), ("relax while cooking", "요리하며 쉬다")],
         [("cook with friends", "친구들과 요리하다"), ("make a snack", "간식을 만들다")],
         [("satisfied", "만족스러운"), ("accomplished", "뿌듯한")]],
    19: [[("history", "역사"), ("romance", "로맨스")],
         [("essays", "에세이"), ("newspapers", "신문")],
         [("broadens my mind", "시야를 넓히다"), ("takes me to another world", "다른 세계로 데려가다")],
         [("an adventure story", "모험 이야기"), ("a science book", "과학책")],
         [("open-minded", "열린 마음의"), ("patient", "인내심 있는")]],
    20: [[("New Year's Day", "새해"), ("summer vacation", "여름방학")],
         [("the fun events", "즐거운 행사"), ("playing with cousins", "사촌들과 노는 것")],
         [("get some rest", "푹 쉬다"), ("enjoy the holiday", "명절을 즐기다")],
         [("special days", "특별한 날"), ("the weekend", "주말")],
    ...
    21: [[("Sokcho", "속초"), ("Yeosu", "여수")],
         ...
         [("climbed a mountain", "산에 올랐다"), ("stayed near the beach", "해변 근처에 묵었다")],
         [("refreshing", "상쾌한"), ("easy", "편한")]],
    22: [[("the UK", "영국"), ("Canada", "캐나다")],
         [("the people", "사람들"), ("the scenery", "경치")],
         [("learn a language", "언어를 배우다"), ("broaden my view", "시야를 넓히다")],
         [("travel across Europe", "유럽을 여행하다"), ("meet foreign friends", "외국 친구를 만나다")],
         [("wonderful", "멋진"), ("special", "특별한")]],
    23: [[("racing", "레이싱"), ("role-playing", "롤플레잉")],
         [("in my free time", "여가 시간에"), ("at home", "집에서")],
         [("a fun break", "즐거운 휴식"), ("exciting", "신나는")],
         [("play with my brother", "형제와 하다"), ("learn new skills", "새 기술을 배우다")],
         [("harmless", "해롭지 않은"), ("refreshing", "상쾌한")]],
    24: [[("a news app", "뉴스 앱"), ("a map app", "지도 앱")],
         [("play games", "게임을 하다"), ("read the news", "뉴스를 읽다")],
         [("watch anything anytime", "언제든 볼 수 있다"), ("share my ideas", "생각을 나누다")],
    ...
    26: [[("cool off", "더위를 식히다"), ("have fun", "즐기다")],
         ...
         [("collected seashells", "조개를 주웠다"), ("took beautiful photos", "멋진 사진을 찍었다")],
    ...
    27: [[("people", "인물"), ("night views", "야경")],
         ...
         [("take pictures of nature", "자연 사진을 찍다"), ("make photo albums", "사진첩을 만들다")],
