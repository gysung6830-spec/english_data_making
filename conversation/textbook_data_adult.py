...
_EXTRA = {
    1: [[("sociable", "사교적인"), ("thoughtful", "사려 깊은")],
        [("my work", "내 일"), ("personal growth", "자기 성장")],
        [("stay organized", "정리를 잘한다"), ("keep an open mind", "열린 마음을 유지한다")],
        [("meet up with friends", "친구들과 만난다"), ("try new things", "새로운 걸 시도한다")],
        [("easygoing", "느긋한"), ("motivated", "의욕적인")]],
    2: [[("challenging", "도전적인"), ("engaging", "흥미로운")],
        [("helping people", "사람을 돕는 것"), ("learning new skills", "새 기술을 배우는 것")],
        [("keep learning", "계속 배운다"), ("work with great people", "좋은 사람들과 일한다")],
        [("answer emails", "이메일에 답한다"), ("plan my tasks", "업무를 계획한다")],
        [("fulfilling", "충족감을 주는"), ("worth the effort", "노력할 가치가 있는")]],
    3: [[("peaceful", "평화로운"), ("clean", "깨끗한")],
        [("the friendly neighbors", "정겨운 이웃"), ("the quiet streets", "조용한 거리")],
        [("it feels like home", "집처럼 편하다"), ("it has everything I need", "필요한 게 다 있다")],
        [("go to a nearby park", "근처 공원에 간다"), ("try local restaurants", "동네 맛집에 간다")],
        [("relaxing", "편안한"), ("homey", "아늑한")]],
    4: [[("caring", "배려심 있는"), ("loyal", "의리 있는")],
        [("patience", "인내"), ("thoughtfulness", "사려 깊음")],
        [("truly listen to each other", "서로 귀 기울인다"), ("accept our differences", "서로의 차이를 받아들인다")],
        [("call each other", "서로 전화한다"), ("share good news", "좋은 소식을 나눈다")],
        [("supportive", "힘이 되는"), ("genuine", "진실된")]],
    5: [[("enjoying nature", "자연 즐기기"), ("getting outdoors", "야외로 나가기")],
        [("take it easy", "여유를 부린다"), ("spend time outdoors", "야외에서 시간을 보낸다")],
        [("reset for the week", "한 주를 준비한다"), ("forget my worries", "걱정을 잊는다")],
        [("order in and relax", "배달시켜 쉰다"), ("read a good book", "좋은 책을 읽는다")],
        [("content", "만족스러운"), ("energized", "활력 넘치는")]],
    6: [[("gardening", "원예"), ("writing", "글쓰기")],
        [("photography", "사진"), ("baking", "베이킹")],
        [("relax and recharge", "쉬고 재충전한다"), ("learn something new", "새로운 걸 배운다")],
        [("make time on weekends", "주말에 시간을 낸다"), ("take a class", "강좌를 듣는다")],
        [("enjoyable", "즐거운"), ("valuable", "값진")]],
    7: [[("taking daily walks", "매일 걷기"), ("playing a sport", "스포츠를 하기")],
        [("drink enough water", "물을 충분히 마신다"), ("take the stairs", "계단을 이용한다")],
        [("sleep better", "잠을 더 잘 잔다"), ("feel confident", "자신감이 생긴다")],
        [("go for a run", "달리기하러 간다"), ("do home workouts", "홈트를 한다")],
        [("refreshed", "상쾌한"), ("motivated", "의욕 있는")]],
    8: [[("Chinese", "중식"), ("Indian", "인도")],
        [("light", "담백한"), ("flavorful", "풍미 있는")],
        [("relax and enjoy", "편히 즐긴다"), ("spend time with others", "사람들과 시간을 보낸다")],
        [("make a reservation", "예약을 한다"), ("try a new dish", "새 음식을 시도한다")],
        [("treats", "즐거움"), ("delights", "기쁨")]],
    9: [[("read a book", "책을 읽다"), ("have a chat", "담소를 나누다")],
        [("a flat white", "플랫화이트"), ("an iced tea", "아이스티")],
        [("relaxing", "편안한"), ("quiet", "조용한")],
        [("catch up with a friend", "친구와 이야기한다"), ("take a short break", "잠시 쉰다")],
        [("comfort", "위안"), ("habit", "습관")]],
    10: [[("Sokcho", "속초"), ("Yeosu", "여수")],
         [("with friends", "친구와"), ("on a road trip", "자동차 여행으로")],
         [("unwind completely", "완전히 쉰다"), ("discover hidden spots", "숨은 명소를 발견한다")],
         [("explored a small town", "작은 마을을 둘러봤다"), ("went on a food trip", "맛집 투어를 갔다")],
         [("easy", "편한"), ("enjoyable", "즐거운")]],
    11: [[("Spain", "스페인"), ("Thailand", "태국")],
         [("the architecture", "건축"), ("the markets", "시장")],
         [("see the world differently", "세상을 다르게 본다"), ("grow as a person", "사람으로 성장한다")],
         [("tried street food", "길거리 음식을 먹었다"), ("got lost on purpose", "일부러 헤맸다")],
         [("memorable", "기억에 남는"), ("refreshing", "상쾌한")]],
    12: [[("mysteries", "미스터리"), ("romances", "로맨스")],
         [("a strong message", "강한 메시지"), ("realistic characters", "현실적인 인물")],
         [("inspire me", "영감을 준다"), ("stay with me", "여운이 남는다")],
         [("an award-winning drama", "수상작 드라마"), ("a gripping thriller", "몰입되는 스릴러")],
         [("de-stress", "스트레스를 풀다"), ("wind down", "긴장을 풀다")]],
    13: [[("R&B", "알앤비"), ("rock", "록")],
         [("on the way home", "귀갓길에"), ("before sleep", "자기 전에")],
         [("helps me relax", "쉬게 한다"), ("motivates me", "동기를 준다")],
         [("share songs with friends", "친구와 노래를 공유한다"), ("hum along", "흥얼거린다")],
         [("enjoyable", "즐거운"), ("comforting", "위안이 되는")]],
    14: [[("visiting outlets", "아울렛 방문"), ("browsing in person", "직접 둘러보기")],
         [("books", "책"), ("cosmetics", "화장품")],
         [("convenient", "편리한"), ("stress-free", "부담 없는")],
         [("check reviews first", "후기를 먼저 본다"), ("look for coupons", "쿠폰을 찾는다")],
         [("careful", "신중한"), ("thrifty", "알뜰한")]],
    15: [[("video calls", "영상 통화"), ("navigation apps", "내비 앱")],
         [("pay bills", "요금을 낸다"), ("learn new things", "새로운 걸 배운다")],
         [("comfortable", "편안한"), ("accessible", "접근하기 쉬운")],
         [("set reminders", "알림을 설정한다"), ("take notes", "메모한다")],
         [("with balance", "균형 있게"), ("only when needed", "필요할 때만")]],
    16: [[("Facebook", "페이스북"), ("X (Twitter)", "엑스")],
         [("find inspiration", "영감을 얻는다"), ("promote my work", "내 일을 알린다")],
         [("learn from others", "남에게서 배운다"), ("stay up to date", "최신 소식을 안다")],
         [("like and comment", "좋아요와 댓글을 단다"), ("follow new accounts", "새 계정을 팔로우한다")],
         [("waste hours on it", "몇 시간을 낭비하다"), ("believe everything", "모든 걸 믿다")]],
    17: [[("late autumn", "늦가을"), ("early spring", "이른 봄")],
         [("breezy", "산들바람 부는"), ("clear", "맑은")],
         [("the air feels fresh", "공기가 상쾌하다"), ("the days are longer", "낮이 길어진다")],
         [("go on a picnic", "소풍을 간다"), ("ride my bike", "자전거를 탄다")],
         [("motivation", "의욕"), ("sleep", "수면")]],
    18: [[("my birthday", "내 생일"), ("a long weekend", "연휴")],
         [("the warm mood", "따뜻한 분위기"), ("the home-cooked food", "집밥")],
         [("slow down", "여유를 갖는다"), ("be with loved ones", "사랑하는 이들과 있는다")],
         [("cook together", "함께 요리한다"), ("catch up", "안부를 나눈다")],
         [("special", "특별한"), ("heartwarming", "훈훈한")]],
    19: [[("taking on challenges", "도전을 받아들이기"), ("asking for feedback", "피드백을 구하기")],
         [("my health", "건강"), ("my confidence", "자신감")],
         [("keep improving", "계속 나아진다"), ("achieve my dreams", "꿈을 이룬다")],
         [("journal every day", "매일 일기를 쓴다"), ("learn a new skill", "새 기술을 배운다")],
         [("driven", "의욕적인"), ("positive", "긍정적인")]],
    20: [[("taking regular breaks", "규칙적으로 쉬기"), ("unplugging often", "자주 전자기기를 끄기")],
         [("listen to music", "음악을 듣는다"), ("get some fresh air", "바람을 쐰다")],
         [("feel calmer", "더 차분해진다"), ("see things clearly", "명확히 본다")],
         [("take a long bath", "오래 목욕한다"), ("go to bed early", "일찍 잔다")],
         [("grounded", "안정된"), ("content", "만족스러운")]],
    21: [[("steady", "한결같은"), ("productive", "생산적인")],
         [("flexible", "유연한"), ("disciplined", "자기 관리가 되는")],
         [("stay balanced", "균형을 유지한다"), ("feel prepared", "준비된 느낌이다")],
         [("have a quick breakfast", "간단히 아침을 먹는다"), ("review my to-do list", "할 일을 점검한다")],
         [("organized", "정돈된"), ("calm", "차분한")]],
    22: [[("the train", "기차"), ("a bicycle", "자전거")],
         [("comfortable", "편안한"), ("predictable", "예측 가능한")],
         [("eco-friendly", "친환경적인"), ("stress-free", "부담 없는")],
         [("listen to music", "음악을 듣는다"), ("catch up on reading", "밀린 독서를 한다")],
         [("productive", "생산적인"), ("quiet", "조용한")]],
    23: [[("ironing", "다림질"), ("mopping", "걸레질")],
         [("dusting", "먼지 털기"), ("doing dishes", "설거지")],
         [("it clears my head", "머리가 맑아진다"), ("it feels satisfying", "만족스럽다")],
         [("wipe the windows", "창문을 닦는다"), ("reorganize my closet", "옷장을 정리한다")],
         [("satisfied", "만족스러운"), ("calm", "차분한")]],
    24: [[("enjoyable", "즐거운"), ("wholesome", "건강에 좋은")],
         [("soup", "수프"), ("a salad", "샐러드")],
         [("eat healthier", "더 건강하게 먹는다"), ("get creative", "창의력을 발휘한다")],
         [("make a simple meal", "간단한 식사를 만든다"), ("cook something new", "새로운 걸 요리한다")],
         [("enjoyable", "즐거운"), ("satisfying", "만족스러운")]],
    25: [[("a cool room", "시원한 방"), ("a light dinner", "가벼운 저녁")],
         [("five hours", "5시간"), ("a full eight hours", "꼬박 8시간")],
         [("think clearly", "명료하게 생각한다"), ("stay calm", "침착함을 유지한다")],
         [("stretch a little", "가볍게 스트레칭한다"), ("drink warm tea", "따뜻한 차를 마신다")],
         [("refreshed", "상쾌한"), ("sharp", "또렷한")]],
    26: [[("friends", "친구"), ("life companions", "삶의 동반자")],
         [("cat-loving", "고양이를 좋아하는"), ("animal-loving", "동물을 좋아하는")],
         [("reduce stress", "스트레스를 줄여준다"), ("bring comfort", "위안을 준다")],
         [("greet you warmly", "반갑게 맞아준다"), ("make you smile", "웃게 해준다")],
         [("warm", "따뜻한"), ("rewarding", "보람 있는")]],
    27: [[("exploring the city", "도시를 둘러보며"), ("resting at home", "집에서 쉬며")],
         [("take it slow", "천천히 보낸다"), ("enjoy some quiet time", "조용한 시간을 즐긴다")],
         [("recharge fully", "완전히 재충전한다"), ("do something new", "새로운 걸 한다")],
         [("visit a café", "카페에 간다"), ("catch up on sleep", "밀린 잠을 잔다")],
         [("content", "만족스러운"), ("ready to work", "일할 준비된")]],
    28: [[("over dinner", "저녁을 먹으며"), ("on a walk", "산책하며")],
         [("every few weeks", "몇 주에 한 번"), ("during the holidays", "명절에")],
         [("feel less lonely", "덜 외롭다"), ("share my worries", "고민을 나눈다")],
         [("have a long chat", "오래 이야기한다"), ("try a new place", "새로운 곳에 간다")],
         [("cheerful", "밝은"), ("positive", "긍정적인")]],
}
