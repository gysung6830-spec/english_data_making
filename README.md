...
| **③ 문장별 끊어읽기 & 내용 파악** | 문장을 `/`로 끊고, **해석 어려운(오역 위험) 부분은 밑줄+빈칸(주관식)** 으로 직접 해석(빈칸 출제원리=해석 난이도) · **어법 칩(간단 설명)** · **‘이렇게 읽으면 오답(X) → 왜?’**(의미·역할·논리 오해 5유형: 반대·역할착각·비교·범위·초점) | ○(빈칸·오답찾기) | ○(정답·이유) |
| **④ 글 정리** | 🔎소재 · 🗣필자 의견(긍/부/중) · 🧩글의 구조(6택) · 🔗재진술 사슬(한글 라벨+영어 표현+변주, 필자 핵심 의견 기준·억지 생성 안 함) · 📝**글 내용 정리**(문장별 역할을 달아 `1문장[주제]→2문장[근거]→…` 흐름) | ○(빈칸) | ○(정답) |
