...
1. **분석지** (`*_analysis.pdf`) — 주제·출제 포인트·구조 분석·어휘·직독직해 6개 섹션
2. **어휘 리스트** (`*_wordlist.pdf`) — 직독직해 오른쪽 열의 핵심 어휘를 모아 정리
3. **영단어 시험지** (`*_quiz.pdf`) — 위 어휘를 무작위로 섞어 뜻을 적게 하는 시험지(맨 뒤에 정답)
