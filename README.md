...
| 단계 | 이름 | 이 학생은? / 다루는 문법 |
|---|---|---|
| 1 | 왕기초 | be동사도 헷갈림 · 주어·동사 찾기부터, 모르는 단어 전부, 문법 1~2개 + "지금은 몰라도 OK" |
| 2 | 기초 | 단어만 조금 앎 · 시제·의문/부정문·3인칭 -s |
| 3 | 기본 | 중등 문법 절반쯤 · to부정사·동명사·관계사 입문 |
| 4 | 표준 | 고1 평균 · 지문 핵심 문법 전부(내신 대비) |
| 5 | 실전 | 상위권·심화 · 어법 함정·서술형까지 |
