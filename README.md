...
| **③ 문장별 끊어읽기 & 내용 파악** | 문장을 `/`로 끊고, **오역 위험 부분은 밑줄+빈칸(주관식)** 으로 직접 해석 · **어법 칩(간단 설명)** · **‘이렇게 읽으면 오답(X) → 왜 틀렸을까?’**(흔한 오해를 바로잡으며 뜻·흐름을 쉽게 이해) | ○(빈칸·오답찾기) | ○(정답·이유) |
| **④ 글 예측** | 🔎소재 · 🗣필자 의견(긍/부/중) · 🧩글의 구조(6택) · 🔗재진술 사슬(**영어**, 필자 핵심 의견 기준·억지 생성 안 함) → **학생이 예측** | ○(빈칸) | ○(정답) |
