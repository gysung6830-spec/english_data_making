...
def mock_lecture_passage(title: str = "Fear and Social Development",
    ...
    items = [
        SentenceItem(
            ...
            mistranslation="the role that fear can play 를 '두려움이 연기하는 역할'처럼 읽기 쉬운데, play a role in(~에서 역할을 하다)이 관계사로 쪼개진 형태야. those도 '그것들'이 아니라 '연구자들'이야.",
        ...
        SentenceItem(
            ...
            mistranslation="until을 '~까지 멈춘다'가 아니라 '멈추지 않는다'처럼 반대로 꼬아 읽기 쉬워. has been comforted는 수동이라 '아기가 위로한다'가 아니라 '위로받는다'야.",
        ...
        SentenceItem(
            ...
            mistranslation="than will infants who are not 에서 도치와 생략이 있어. '아기들이 하지 않을 것'이 아니라 '자주 겁먹지 않는 아기들보다'라는 비교 대상이야.",
        ...
        SentenceItem(
            ...
            mistranslation="serve를 '봉사하다'로 읽으면 망해 — serve to slow down은 '늦추는 작용을 한다'는 뜻이야. voluntary restraints도 '자발적 봉사'가 아니라 아기가 스스로 탐색·놀이를 멈추는 자기 제약이야.",
