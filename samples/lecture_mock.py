        ...
        key_grammar=KeyGrammar(
            ...
            drills=[
                GrammarDrill(kind="객관식",
                             question="than 뒤에 도치가 일어난 문장으로 어법상 옳은 것은?",
                             options=["He runs faster than does his brother.",
                                      "He runs faster than his brother does run.",
                                      "He runs faster than his brother runs does."],
                             answer="He runs faster than does his brother."),
                GrammarDrill(kind="객관식",
                             question="'than will infants who are not' 에서 생략된 말로 알맞은 것은?",
                             options=["의미상 뒤에 have 가 생략됨",
                                      "뒤에 are 가 생략됨",
                                      "생략된 것이 없음"],
                             answer="의미상 뒤에 have 가 생략됨"),
                GrammarDrill(kind="객관식",
                             question="밑줄 친 than 의 문법적 성격으로 알맞은 것은?",
                             options=["뒤에 '절'이 오므로 접속사",
                                      "뒤에 '명사'만 오므로 전치사",
                                      "부사"],
                             answer="뒤에 '절'이 오므로 접속사"),
