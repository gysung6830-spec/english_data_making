...
파일을 받는 순간 그 파일에만 **그 주문의 번호**가 박힙니다.
막을 수는 없지만, 카페나 단톡방에 올라오면 주문 목록에서 누구 것인지
바로 찾을 수 있습니다. 자료 유출을 줄이는 가장 확실한 방법입니다.

이름·이메일은 지면에 찍지 않습니다. 학생에게 그대로 나눠 줘도
남의 개인정보가 딸려 가지 않게 하기 위해서입니다.
