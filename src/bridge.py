...
LEVELS = {
    1: {"key": "왕기초",
        "desc": "be동사도 헷갈리는 학생 · 주어·동사 찾기부터, 모르는 단어 전부",
        "vocab": "지문에서 조금이라도 모를 만한 단어를 거의 전부 (최대한 많이, 25개 이상 가능)",
        "grammar": "가장 쉬운 문법 1~2개(문장 뼈대: 주어+동사, be동사 정도)만. 어려운 문법은 설명하지 말고 마지막에 kind='note'로 '지금은 몰라도 OK, 나중에 배워요' 카드 1개",
        "tone": "초등학생에게 말하듯 아주 쉬운 우리말. 문법 용어는 최소화하고 풀어서 설명"},
    2: {"key": "기초",
        "desc": "단어만 조금 아는 학생 · 시제·의문/부정문·3인칭 -s",
        "vocab": "모를 만한 단어 다수(20개 안팎)",
        "grammar": "중등 기초 문법 2~3개(be동사, 일반동사 -s, 과거형, 조동사 등 지문에 나온 쉬운 것 위주). 어려운 건 kind='note'로 가볍게",
        "tone": "친근한 '~해요' 말투로 밑바닥부터"},
    3: {"key": "기본",
        "desc": "중등 문법 절반쯤 · to부정사·동명사·관계사 입문",
        "vocab": "핵심+중등 단어 위주(16개 안팎)",
        "grammar": "지문의 핵심 문법 3~4개(to부정사·동명사·관계대명사·비교 등 포함 가능). 하나는 kind='core'",
        "tone": "친근하지만 표준적인 설명"},
    4: {"key": "표준",
        "desc": "고1 평균 · 지문 핵심 문법 전부(내신 대비)",
        "vocab": "고1 핵심 어휘 위주(14개 안팎)",
        "grammar": "지문의 핵심 문법 4~5개를 정확히. 가정법·완료·수동태·분사구문 등 포함",
        "tone": "표준적인 내신 대비 설명"},
    5: {"key": "실전",
        "desc": "상위권·심화 · 어법 함정·서술형까지",
        "vocab": "고난도·핵심 어휘 위주(12개 안팎), 유의어/반의어 언급 가능",
        "grammar": "지문의 문법 포인트를 5개 이상 촘촘히. 시험 출제 포인트·함정을 rule 안에 짚어줌",
        "tone": "내신 심화. 시험에 어떻게 나오는지까지"},
}
