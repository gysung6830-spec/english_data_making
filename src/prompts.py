...
def ws_compose_prompt(title: str, body: str) -> str:
    return (
        ...
        "'하·중' 두 난이도로 제시하는데, 난이도는 '주어지는 단어의 개수'로만 구분합니다.\n"
        "- items 3~4개, 각 {korean, conditions, given_low, given_mid, word_count, answer, explanation}.\n"
        "- korean: 영작해야 할 우리말 문장(지문 문장의 자연스러운 번역).\n"
        "- answer: 지문의 원문 문장(그대로). 정답은 반드시 지문에 있는 문장이어야 합니다. "
        "하·중 모두 정답은 이 문장 하나로 같습니다.\n"
        ...
        "  · given_mid(중): 핵심 단어의 '절반 정도'만 제공(하보다 적게).\n"
        "  두 목록 모두 정답 문장에 실제로 쓰인 단어여야 하고, given_low 가 given_mid 보다 많아야 합니다. "
        "기능어(관사·전치사)는 굳이 안 넣어도 됩니다.\n"
