...
def ws_error_prompt(title: str, body: str) -> str:
    return (
        "[유형6: 어법 오류 수정] 지문 문장을 바탕으로, 어법 포인트 '5곳에 밑줄'을 치고 그중 "
        "'정확히 3곳'을 일부러 어법상 틀리게 바꾼 문항을 '정확히 3개' 만드세요. "
        "학생은 밑줄 5곳 중 틀린 3곳을 찾아 바르게 고칩니다.\n"
        "- items 3개, 각 {sentence, underlines, explanation}.\n"
        "- sentence: 지문 문장(또는 지문 내용에 맞는 문장). 밑줄 칠 표현 5곳을 각각 {{n|표현}} 형식으로 "
        ...
        "형용사/부사 구별, 병렬 등.\n"
        "- 5곳 중 '정확히 3곳'만 wrong=true(틀림), 나머지 2곳은 wrong=false(어법상 옳음)이어야 합니다.\n"
        "- [검증] 반드시 스스로 재검토하세요: 틀린 3곳은 '실제 어법상 명백히 틀려야' 하고, "
        "옳은 2곳은 '실제 어법상 완전히 옳아야' 합니다. 애매하거나 문체상 어색할 뿐인 것은 넣지 마세요. "
        "correction 은 그 자리에서 어법적으로 정확한 표현이어야 합니다.\n"
