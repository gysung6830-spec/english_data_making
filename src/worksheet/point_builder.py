...
_GRAMMAR_KW = (
    ...
    "가정", "병렬", "병치", "형식", "의미상", "주어", "목적어", "보어", "부사절", "명사절", "형용사절",
    "전치사", "수동", "능동", "도치", "강조", "생략", "대명사", "시제", "조동사", "원형",
    "동격", "간접", "직접", "진주어", "가주어", "부사적", "형용사적", "명사적", "복수", "단수",
    # ── 보강: 회색으로 잘 새던 어법 용어들 ──
    "최상", "완료", "진행", "선행사", "지각", "사역", "관용", "숙어", "삽입", "구문",
    "의문사", "복합관계", "부사구", "명사구", "형용사구", "후치", "수식", "상관", "당위",
    # ── 어법성판단(밑줄형) 우선 점검 목록 관련 ──
    "재귀", "감정분사", "정동사", "준동사", "가목적어", "가주어", "부정어", "부분부정", "여부",
)
