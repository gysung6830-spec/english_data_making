...
const categories = [
  {
    ...
    "traps": [
      "전치사에서 끊지 마 — 전치사부터 뒤 명사 끝까지 한 덩어리로 묶어서 읽어야 해.",
      "'A of B'를 '~의'로 곧이곧대로 뒤집지 마 — 'B의 A'로 순서를 바꿔야 자연스러워.",
      "전치사구가 앞 명사를 꾸미는지(어떤 명사?) 문장을 꾸미는지(언제·어디서) 헷갈리지 마."
    ],
    "intro": [
  ...
  },
  {
    ...
    "traps": [
      "be + p.p.를 그냥 과거로 읽지 마 — 주어가 '당하는·되는' 쪽이야('~되다·~당하다').",
      "'by + 명사'는 '누가 했는지'(행위자)일 뿐, 문장의 주인공은 당하는 주어야.",
      "-ed 가 다 과거동사는 아니야 — be동사 뒤의 -ed 는 '수동'(과거분사)일 수 있어."
    ],
    "intro": [
  ...
  },
  {
    ...
    "traps": [
      "to 뒤에 동사원형이 오면 '~로/에게'(전치사)가 아니라 부정사야 — 방향으로 읽지 마.",
      "to부정사가 명사(~하는 것)·형용사(~할)·부사(~하기 위해) 중 뭔지 '자리'로 판단해.",
      "'~하기 위해'로만 외우지 마 — 감정 표현 뒤 to 는 '~해서'(원인)일 때도 많아."
    ],
    "intro": [
  ...
  },
  {
    ...
    "traps": [
      "-ing 를 무조건 '~하는 중'(진행)으로 읽지 마 — 주어·목적어 자리면 '~하는 것'(동명사)이야.",
      "전치사 뒤 -ing 는 동명사 — 'to' 뒤라도 전치사 to 면 동사원형이 아니라 -ing 가 와.",
      "동명사(명사 역할)인지 현재분사(꾸밈 역할)인지, 문장에서 하는 일로 구분해."
    ],
    "intro": [
  ...
  },
  {
    ...
    "traps": [
      "관계사(who/which/that)는 앞 명사를 꾸미는 절의 시작 — 새 문장으로 착각하지 마.",
      "명사 뒤에 갑자기 '주어+동사'가 오면, 사이에 관계대명사가 생략된 거야.",
      "that 이 관계사인지 접속사인지 헷갈리면, 뒤 문장에 빠진 자리(주어·목적어)가 있는지 봐."
    ],
    "intro": [
  ...
  },
  {
    ...
    "traps": [
      "명사 앞뒤의 -ing/-ed 는 진짜 동사가 아니라 '꾸미는 말'(분사) — 동사와 헷갈리지 마.",
      "-ing(능동·하는)와 -ed(수동·당한)의 방향을 반대로 읽지 마.",
      "명사 뒤에 분사가 길게 붙으면(뒤에서 꾸밈), 그 명사의 진짜 동사는 더 뒤에 있어."
    ],
    "intro": [
  ...
  },
  {
    ...
    "traps": [
      "문장 앞뒤의 '-ing ~,'는 '접속사+주어'가 지워진 곁다리 — 주절의 진짜 동사를 따로 찾아.",
      "분사구문의 -ing 를 주절 동사로 착각하지 마 — 콤마 건너에 진짜 동사가 있어.",
      "의미(때·이유·조건·동시동작)는 문맥으로 채워 — '~하면서·~해서·~하자'."
    ],
    "intro": [
