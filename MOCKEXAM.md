...
python run_mock.py schools                         # 등록 학교 목록
python run_mock.py generate --school jinyang_hs --grade 1 --difficulty 중 \
...
```bash
python run_mock.py generate --school jinyang_hs --input input --out output
```
...
```bash
python run_mock.py learn --school jinyang_hs --name 2026_2_final \
