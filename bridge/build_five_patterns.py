...
<div class="cover"><div class="cover-in">
  ...
  <div class="cov-dia">
    <div class="cov-row"><span class="n">1형식</span><span class="cov-chip">누가</span><span class="cov-chip">한다</span></div>
    <div class="cov-row"><span class="n">2형식</span><span class="cov-chip">누가</span><span class="cov-chip">이다·되다</span><span class="cov-chip">어떠하다</span></div>
    <div class="cov-row"><span class="n">3형식</span><span class="cov-chip">누가</span><span class="cov-chip">한다</span><span class="cov-chip">무엇을</span></div>
    <div class="cov-row"><span class="n">4형식</span><span class="cov-chip">누가</span><span class="cov-chip">준다</span><span class="cov-chip">누구에게</span><span class="cov-chip">무엇을</span></div>
    <div class="cov-row"><span class="n">5형식</span><span class="cov-chip">누가</span><span class="cov-chip">한다</span><span class="cov-chip">무엇을</span><span class="cov-chip">= 어떻게</span></div>
  </div>
  <div class="cbox"><h3>이 교재는요</h3><ul>
    <li>문장을 <b>색깔 블록</b>으로 보여줘 구조가 한눈에 들어와요.</li>
    <li>어려운 문법 용어 없이 <b>&lsquo;누가·한다·무엇을&rsquo;</b> 같은 쉬운 말로 설명해요.</li>
...
<div class="sec" id="intro">
  ...
  <div class="concept">영어 문장은 <b>동사(한다)</b>가 뼈대를 정해요. 동사에 따라 뒤에 <b>&lsquo;무엇을&rsquo;</b>이 오기도,
  <b>&lsquo;어떠하다&rsquo;(설명)</b>가 오기도 해요. 문장을 만드는 <b>덩어리 4가지</b>만 색으로 익히면 구조가 바로 보여요.</div>

  <div class="h">문장을 만드는 4덩어리 — 색으로 기억하기</div>
  {dia([("S","누가 (주어)","Birds 새가"),("V","한다 (동사)","sing 노래한다"),("O","무엇을 (목적어)","a song 노래를"),("C","어떠하다 (보어)","= 설명하는 말")],
       rel=f'{dot("S")}누가 {dot("V")}한다 {dot("O")}무엇을 {dot("C")}어떠하다 &nbsp;·&nbsp; 회색은 <b>꾸미는 말</b> (없어도 문장이 되는 말)')}
  <div class="note"><b>&lsquo;무엇을&rsquo;과 &lsquo;어떠하다&rsquo;의 차이</b> — &lsquo;무엇을&rsquo;은 <b>동작을 받는 대상</b>(노래<b>를</b> 부른다),
  &lsquo;어떠하다&rsquo;는 <b>앞말을 = 로 설명</b>(그녀 <b>=</b> 선생님). 이 둘만 구별하면 5형식이 다 풀려요.</div>
  ...
  {dia([("S","누가","He"),("op","+"),("V","준다","gave"),("op","+"),("O","누구에게","me"),("op","+"),("O","무엇을","a book")], rel="④ 4형식 — me(나에게) + a book(책을)")}
  {dia([("S","누가","We"),("op","+"),("V","한다","call"),("op","+"),("O","무엇을","him"),("op","+"),("C","어떻게","a genius")], rel=f'⑤ 5형식 — {dot("O")}him(그를) <span class="eq">=</span> {dot("C")}a genius(천재라고)')}

  <div class="tip"><span class="l">핵심 한 줄</span>동사 뒤에 <b>&lsquo;무엇을&rsquo;</b>이 오면 그건 <b>받는 대상</b>, <b>&lsquo;= 설명&rsquo;</b>이 오면 그건 <b>앞말을 꾸며 주는 말</b>. 이 둘만 나누면 돼요!</div>
...
S1 = unit(1, "1형식", "누가 + 한다", "주어 + 동사",
    ["<b>&lsquo;누가 + 한다&rsquo;</b>만으로 문장이 끝나는 경우를 안다",
     "뒤에 붙은 <b>꾸미는 말</b>(in the sky 등 없어도 되는 말)을 가려낸다",
    ...
    "1형식은 <b>&lsquo;누가 + 한다&rsquo;</b>만으로 뜻이 끝나요. 뒤에 &lsquo;무엇을&rsquo;이 없어도 되는 동사예요. "
    "「<b>There is/are ~</b>」(~이 있다)도 1형식이에요.",
    ...
    "<b>in the east(동쪽에서)</b>처럼 <b>in·on·at</b>으로 시작하는 말은 <b>꾸미는 말</b>! 괄호로 묶어 빼세요. 뒤에 &lsquo;무엇을&rsquo;이 없으면 1형식.",
    "<b>꾸미는 말(in·on·at…으로 시작하는 말)을 지운 뒤 몇 형식인지 판단</b>하는 문제가 자주 나와요. &lsquo;There is/are ~&rsquo;도 "
    "1형식이라는 걸 <b>꼭</b> 물어봐요. &lsquo;무엇을&rsquo;이 없다고 당황하지 않기.",
    "① <b>&lsquo;무엇을&rsquo; 없이 끝나는 동사</b>: go·come·live·arrive·happen·rise… "
    "② <b>There is/are ~ = 1형식</b>. ③ <b>in·on·at으로 시작하는 말</b>(장소·시간)은 <b>꾸미는 말</b> → 형식 셀 때 뺀다.",
...
S2 = unit(2, "2형식", "누가 + 이다 + 어떠하다", "주어 + 동사 + 보어",
    ["동사 뒤 말이 <b>앞 사람을 &lsquo;= 로 설명&rsquo;</b>한다는 걸 이해한다 (그녀 = 선생님)",
     "<b>look·feel처럼 느낌을 말하는 동사</b> 뒤엔 happy 같은 <b>&lsquo;상태를 나타내는 말&rsquo;</b>이 옴을 안다",
    ...
    "2형식은 <b>동사 뒤에 &lsquo;어떠하다&rsquo;(설명하는 말)</b>가 오는 문장이에요. "
    "이 설명하는 말은 <b>앞 사람과 &lsquo;= 관계&rsquo;</b>가 돼요. (그녀 = 선생님 / 그녀 = 피곤함)",
    ...
    [("~이다 · ~이 되다", ["be(am/are/is) 이다","become 되다","get ~해지다","grow 자라다·되다","turn 변하다","stay 그대로 있다"]),
     ("느낌을 말하는 동사", ["look 보이다","sound 들리다","smell 냄새나다","taste 맛나다","feel 느껴지다","seem ~같다"])],
    "<b>look·feel처럼 느낌을 말하는 동사</b> 뒤엔 <b>happy</b> 같은 상태말이 와요. "
    "<b>happily</b>(-ly 붙은 말)는 오답! &nbsp;You look <b>happy</b>(○) / happily(✗).",
    "<b>look·feel 뒤에 happy / happily 중 고르기</b>가 단골 문제! <b>-ly 안 붙은 말(happy)</b>이 정답이에요. "
    "&lsquo;앞말 = 뒷말&rsquo;로 이어지는지 물어 2형식인지도 확인시켜요.",
    "① <b>look·sound·smell·taste·feel 뒤엔 -ly 없는 상태말</b>(happy·good·tired…) — -ly 붙이면 오답! "
    "② 자주 쓰는 동사: <b>be·become·get·grow·turn·stay</b>. ③ 확인법: <b>앞말 = 뒷말</b>이면 2형식.",
...
S3 = unit(3, "3형식", "누가 + 한다 + 무엇을", "주어 + 동사 + 목적어",
    ["동사 뒤 <b>&lsquo;무엇을&rsquo;</b>(동작을 받는 대상)을 찾을 수 있다",
     "enter·discuss 등은 <b>into·about 없이 바로 &lsquo;무엇을&rsquo;</b>을 붙임을 안다",
     "<b>-ing(~하는 것) / to+동사(~하기)</b> 같은 덩어리도 &lsquo;무엇을&rsquo; 자리에 옴을 안다"],
    ...
    "3형식은 <b>동사 뒤에 &lsquo;무엇을&rsquo;</b>이 오는 문장이에요. 이 &lsquo;무엇을&rsquo;은 <b>동작을 받는 대상</b>이에요. "
    "&lsquo;무엇을&rsquo; 자리엔 <b>한 단어</b>뿐 아니라 <b>-ing(~하는 것)·to+동사(~하기)</b> 덩어리도 올 수 있어요.",
    [("<span class='S'>She</span> <span class='V'>reads</span> <span class='O'>books</span>.", "그녀는 책을 읽는다."),
     ("<span class='S'>We</span> <span class='V'>enjoy</span> <span class='O'>playing soccer</span>.", "우리는 축구하는 것을 즐긴다. (-ing = ~하는 것)"),
     ("<span class='S'>I</span> <span class='V'>want</span> <span class='O'>to sleep</span>.", "나는 자기를 원한다. (to+동사 = ~하기)")],
    [("", ["love 사랑하다","like 좋아하다","have 가지다","read 읽다","make 만들다","eat 먹다","want 원하다","know 알다","meet 만나다","buy 사다"])],
    "동사 뒤에 &lsquo;무엇을&rsquo;이 있으면 3형식. 단, <b>enter·discuss·marry·reach·answer·resemble</b>는 "
    "<b>into·about 같은 말 없이 바로</b> &lsquo;무엇을&rsquo;을 붙여요! (enter <b>into</b> the room ✗)",
    "<b>enter·discuss 뒤에 into·about를 넣으면 오답</b>인 걸 자주 물어봐요 "
    "(enter <b>into</b>✗, discuss <b>about</b>✗). &lsquo;무엇을&rsquo; 자리에 온 <b>-ing/to+동사</b>를 찾는 문제도 나와요.",
    "① <b>바로 &lsquo;무엇을&rsquo;을 붙이는 동사</b>(into·about 금지): <u>discuss · marry · enter · reach · resemble · answer</u>. "
    "② &lsquo;무엇을&rsquo; 자리 = 한 단어 · <b>-ing(~하는 것) · to+동사(~하기)</b>.",
...
S4 = unit(4, "4형식", "누가 + 준다 + 누구에게 + 무엇을", "주어 + 동사 + 목적어 두 개",
    ["동사 뒤에 <b>&lsquo;누구에게&rsquo; + &lsquo;무엇을&rsquo;</b> 두 개가 오는 문장을 안다",
     "순서는 <b>사람(누구에게) 먼저, 물건(무엇을) 나중</b>임을 안다",
     "<b>to·for·of</b>를 써서 다르게 쓰는 법을 익힌다"],
    dia([("S","누가","He"),("op","+"),("V","준다","gave"),("op","+"),("O","누구에게","me"),("op","+"),("O","무엇을","a book")],
    ...
    "4형식은 <b>동사 뒤에 &lsquo;누구에게&rsquo; + &lsquo;무엇을&rsquo;</b> 두 개가 오는 문장이에요. &lsquo;주다&rsquo;류 동사에 쓰여요. "
    "순서는 <b>사람(누구에게) 먼저, 물건(무엇을) 나중</b>이에요.",
    ...
    [("to를 붙이는 동사", ["give 주다","tell 말하다","send 보내다","show 보여주다","teach 가르치다","lend 빌려주다"]),
     ...
     ("of를 붙이는 동사", ["ask 묻다"])],
    "순서를 바꿔 &lsquo;무엇을&rsquo;을 앞으로 보내면, 사람 앞에 <b>to·for·of</b> 중 하나를 붙여요. "
    "<b>대부분 to</b> · buy·make·get·cook → <b>for</b> · ask → <b>of</b>.",
    "<b>사람 앞에 to·for·of 중 무엇을 붙일지 고르기</b>가 가장 많이 나와요! 동사에 맞는 걸 물어봐요. "
    "또 4형식인지 <b>5형식인지 구별</b>(뒷말 두 개가 다른 대상인가?)하는 문제도 나와요.",
    "붙이는 말 3그룹 — ① <b>to</b>: give·tell·send·show·teach·lend &nbsp; "
...
S5 = unit(5, "5형식", "누가 + 한다 + 무엇을 + 어떻게", "주어 + 동사 + 목적어 + 보어",
    ["동사 뒤 <b>&lsquo;무엇을&rsquo; + &lsquo;어떻게(= 설명)&rsquo;</b>가 오는 문장을 안다 (그를 = 천재라고)",
     "<b>시키는 동사(make·have·let)·보고 듣는 동사(see·hear…)</b> 뒤엔 <b>to 없는 동사</b>가 옴을 안다",
    ...
    "5형식은 <b>&lsquo;무엇을&rsquo; 뒤에 그것을 설명하는 말</b>이 하나 더 오는 문장이에요. 뒷말이 <b>&lsquo;무엇을&rsquo;과 = 관계</b>가 돼요. "
    "설명하는 말 자리엔 상태말·<b>to+동사</b>가 오고, <b>시키는 동사(make·have·let)·보고 듣는 동사(see·hear·feel·watch)</b> 뒤엔 <b>to 없는 동사</b>가 와요.",
    [("<span class='S'>She</span> <span class='V'>made</span> <span class='O'>me</span> <span class='C'>happy</span>.", "그녀는 나를 행복하게 했다. (나 = 행복함)"),
     ("<span class='S'>I</span> <span class='V'>want</span> <span class='O'>you</span> <span class='C'>to stay</span>.", "나는 네가 머물기를 원한다. (to+동사)"),
     ("<span class='S'>He</span> <span class='V'>let</span> <span class='O'>me</span> <span class='C'>go</span>.", "그는 나를 가게 해 줬다. (let 뒤 to 없는 go)")],
    [("뒤에 상태말·이름", ["make ~하게 하다","call ~라 부르다","name 이름 짓다","keep ~한 채 두다","find ~라고 느끼다"]),
     ("뒤에 to+동사", ["want 원하다","ask 부탁하다","tell 시키다","allow 허락하다","expect 기대하다"]),
     ("뒤에 to 없는 동사", ["make 시키다","have 시키다","let 허락하다","see 보다","hear 듣다","feel 느끼다","watch 보다"])],
    "<b>4형식과 5형식 구별</b> — 뒷말 둘이 &lsquo;누구에게 무엇을&rsquo;(다른 것)이면 4형식, "
    "<b>&lsquo;무엇을&rsquo; = 뒷말</b>(같은 것)이면 5형식! He made me <u>a cake</u>(4형식) ↔ He made me <u>happy</u>(5형식).",
    "<b>시키는·보는 동사 뒤에 go / to go 중 고르기</b>가 가장 많이 나와요! (let me <b>go</b>○ / to go✗, saw him <b>run</b>○). "
    "반대로 want·tell·ask 뒤엔 <b>to+동사</b>(want you <b>to</b> stay). <b>4형식·5형식 구별</b>도 자주 나와요.",
    "① <b>make·have·let(시키다) + to 없는 동사</b>. ② <b>see·hear·feel·watch(보다·듣다) + to 없는 동사</b>. "
    "③ <b>want·ask·tell·allow·expect + to+동사</b>. ④ 확인법: <b>&lsquo;무엇을&rsquo; = 뒷말</b>이면 5형식.",
...
<div class="sec" id="summary">
  ...
  {dia([("S","누가","He"),("op","+"),("V","준다","gave"),("op","+"),("O","누구에게","me"),("op","+"),("O","무엇을","a book")], rel="4형식 · 누가 + 준다 + 누구에게 + 무엇을")}
  ...
  <table class="sum">
    ...
    <tbody>
      <tr><td><b>①</b></td><td>아무것도 없다 (꾸미는 말만)</td><td><b>1형식</b></td></tr>
      <tr><td><b>②</b></td><td>하나 있고 &lsquo;<b>앞말 = 그것</b>&rsquo;로 설명</td><td><b>2형식</b></td></tr>
      <tr><td><b>③</b></td><td>하나 있고 &lsquo;<b>무엇을</b>&rsquo;</td><td><b>3형식</b></td></tr>
      <tr><td><b>④</b></td><td>둘 있고 &lsquo;<b>누구에게 + 무엇을</b>&rsquo; (다른 것)</td><td><b>4형식</b></td></tr>
      <tr><td><b>⑤</b></td><td>둘 있고 &lsquo;<b>무엇을 = 뒷말</b>&rsquo; (같은 것)</td><td><b>5형식</b></td></tr>
    </tbody>
  </table>
  ...
  <div class="exam"><span class="l">빈출 5선</span>
    ① <b>look·feel 뒤 happy / happily 고르기</b> (happy○) &nbsp;
    ② <b>enter·discuss 뒤 into·about 넣지 않기</b> &nbsp;
    ③ <b>사람 앞에 to / for / of 고르기</b> &nbsp;
    ④ <b>make·let·see 뒤 go / to go 고르기</b> (go○) &nbsp;
    ⑤ <b>주어진 문장이 몇 형식인지 판단</b> (특히 4 vs 5, 2 vs 3).</div>

  <div class="h">암기 체크리스트 — 다 외웠나요?</div>
  <div class="memo"><span class="l">이것만은 외우기</span>
    □ <b>느낌 말하는 동사(뒤에 -ly 없는 말)</b>: look·sound·smell·taste·feel &nbsp;
    □ <b>into·about 없이 바로 &lsquo;무엇을&rsquo;</b>: discuss·marry·enter·reach·resemble·answer &nbsp;
    □ <b>사람 앞에 붙이는 말</b>: to(give·tell·send·show·teach·lend) / for(buy·make·get·cook) / of(ask) &nbsp;
    □ <b>시키는 동사(뒤에 to 없는 동사)</b>: make·have·let &nbsp;
    □ <b>보고 듣는 동사(뒤에 to 없는 동사)</b>: see·hear·feel·watch &nbsp;
    □ <b>뒤에 to+동사가 오는 동사</b>: want·ask·tell·allow·expect</div>
