...
## 3-2. "노랑만 읽어도 답이 나오나?" — 정직한 적용범위

핵심 주장을 과장하지 않는다. 유형에 따라 갈린다.

| | 유형 | 노랑만 읽기 |
|---|---|---|
| ✅ 됨 (근거 응집형) | 대의(목적·심경·주장·요지·주제·제목)·**함축·빈칸**·순서·삽입·요약 | 답 근거가 주제·역접·결론 문장에 모임 → 노랑만으로 풀림 |
| ❌ 안 됨 (세부 대조형) | 내용일치·도표·안내문·**어법·어휘** | 칠하는 법이 정반대 — 정독 대신 **선지·밑줄 기준 역스캔** |

- **안전장치**: 노랑만으로 선지가 안 갈리면 → 회색으로 한 단계 확장(예시가 근거인 드문 경우). 회색은 "안 읽는다"가 아니라 "정독하지 않는다".
