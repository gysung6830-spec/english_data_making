"""④ 어휘 생성기 (문맥상 부적절) — 정본에서 지정 단어만 변형. 두 방식 지원.

method="synonym" (기본): 밑줄 5개 중 1개=반의어(정답), 나머지=유의어. 형용사·부사·동사 위주.
method="negation": 밑줄 단어는 원문 그대로 두고, 정답 문장에만 부정어(no/not/neither)를 넣어
