...
[형식] 아래 네 가지를 5개 선지 '모두'에 똑같이 지켜야 합니다. 하나만 모양이 달라도 학생이
내용을 읽지 않고 그 하나를 고르게 되어 문제가 무너집니다.
  ...
  (4) 5개의 '모양'을 통일하세요. 명사구면 다섯 개 다 명사구, 의문형이면 다섯 개 다 의문형처럼
      한 갈래로 맞춥니다. 넷은 짧은 명사구인데 하나만 완결된 서술문이면 실격입니다.
