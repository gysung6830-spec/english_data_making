...
HIGH_RISK: dict[str, str] = {
    ...
    "grammar_count": "밑줄 하나하나가 실제로 옳은지/틀린지 다시 따져 '틀린 개수'(정답)가 "
                     "정확한가. 옳다고 본 밑줄 중 하나라도 실은 틀렸거나, 틀렸다고 본 밑줄이 "
                     "실은 옳으면 개수가 어긋나 결함이다. 밑줄 밖 본문의 오류도 확인한다.",
    ...
    # ---- 무관한 문장 ----
    "irrelevant": "정답으로 표시된 문장만 글의 논지에서 벗어나는가. 나머지 4개 문장 중 하나라도 "
                  "흐름에서 벗어나 보이거나, 정답 문장이 오히려 앞뒤와 자연스럽게 이어지면 결함이다.",
}
