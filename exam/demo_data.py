...
def _passage_dna() -> Passage:
    ...
    p.set_qa(CONTENT, *B.make_content_ox(
        ...
        reasons=[
            ...
            "지문은 정확히 그것을 못 박아 부정한다 — 주목할 만한 점은 저장한다는 것"
            "뿐 아니라 '엄청난 양(an enormous amount)'을 담는다는 것이라고 했다. "
            "지문이 강조한 대목을 아니라고 뒤집었다. (부정 뒤집기)",
            ...
            "이루어진 일처럼 읽혀 지문이 말한 것과 달라진다. (조건 삭제)",
            ...
            "옮긴 일치 진술이다.",
            "지문은 '그 효율에 영감을 받아(Inspired by such efficiency)' 연구가 "
            "시작됐다고 했다. 촘촘히 담는 성질이 원인이고 연구가 결과인데, 그 방향이 "
            "뒤집혔다. (인과 역전)",
            "기술이 아직 느리고 비싸다는 것은 맞지만, 필자는 마지막 문장에서 '언젠가 "
            "우리의 도서관과 사진이 분자 안에 안전하게 담길지도 모른다'며 낙관으로 "
            "글을 맺는다. 사실은 맞아도 필자의 결론은 정반대다. (논지·화자 뒤집기)",
...
def _passage_star() -> Passage:
    ...
    p.set_qa(CONTENT, *B.make_content_ox(
        ...
        reasons=[
            ...
            "바로 다음 문장에서 however 로 그것을 반박한다. 통념을 필자의 주장으로 "
            "바꿔치기했다. (논지·화자 뒤집기)",
