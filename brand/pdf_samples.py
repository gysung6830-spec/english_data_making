...
CROPS = [
    ...
    # 뒷면 정리 — 함축의미 출제 포인트 카드와 유의어·반의어 표
    ("analysis-flow.png", "c-analysis-imply.png", (0.50, 0.072, 0.96, 0.262)),
    ("analysis-flow.png", "c-analysis-voca.png", (0.04, 0.518, 0.96, 0.695)),
